...
ENV_SRC = env.c env_utils.c env_utils_2.c
HISTORY_SRC = history.c
LEXING_SRC = lexing.c lexing_utils.c expand.c expand_utils.c expand_utils_2.c  token.c id_token.c quotes.c
...
EXEC_SRC = builtins_call.c envlist_utils.c execute_pipeline.c exec_utils.c
...
SRC = $(P_ENV) $(P_HISTORY) $(P_LEXING) $(P_BUILTINS) $(P_PARSING) $(P_EXEC) $(P_SIGNALS) main.c main_utils.c debug.c
TEST_SRC = test.c
